...
<body>
    @php
        ...
        $defaultPhoto = asset('/images/cv/avatar-default.svg');
        $photoPath = $emp->photo
    ...
    <div class="container-fluid py-3">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="{{ route('employers.cv.export', $Employer->COD_AG) }}" class="btn btn-primary btn-sm" target="_blank">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-2 text-center mb-3 mb-md-0">
                        <img src="{{ $photoPath }}" alt="Photo employe" class="img-fluid rounded border"
                    ...
                    <tbody>
                        @forelse($emp->diplomes as $diplome)
                            <tr>
                                ...
                                <td>{{ $diplome->LL_DIP ?? $diplome->montion ?? 'N/A' }}</td>
